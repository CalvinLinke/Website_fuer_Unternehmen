...
export const PROCESS_STEPS: ProcessStep[] = [
  {
    ...
    title: 'Erstgespräch',
    description:
      'Wir lernen uns kennen — ohne Verkaufsdruck, dafür mit konkreten Fragen zu Ihrem Betrieb, Ihren Zielen und dem, was die aktuelle Website (oder das Fehlen einer solchen) Sie eigentlich kostet.',
    detail:
